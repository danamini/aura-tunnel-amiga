...
.cmdExec:	lea		LSPVolumes(pc),a3
			add.b	d0,d0
			bcc.s	.noVd
			move.b	(a0)+,7(a3)	; shadow volume for HUD and mute
.noVd:		add.b	d0,d0
			bcc.s	.noVc
			move.b	(a0)+,5(a3)	; shadow volume for HUD and mute
.noVc:		add.b	d0,d0
			bcc.s	.noVb
			move.b	(a0)+,3(a3)	; shadow volume for HUD and mute
.noVb:		add.b	d0,d0
			bcc.s	.noVa
			move.b	(a0)+,1(a3)	; shadow volume for HUD and mute
.noVa:		
...
; Aura Tunnel: volumes stay live while muted, without reading write-only Paula registers.
LSPVolumes: dc.w 0,0,0,0
